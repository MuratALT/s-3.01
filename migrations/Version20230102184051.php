 ...
 */
final class Version20230102184051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_vente ADD libelle VARCHAR(255) NOT NULL, ADD commentaire VARCHAR(1000) DEFAULT NULL, ADD date_ajout DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_vente DROP libelle, DROP commentaire, DROP date_ajout');
    }
}
