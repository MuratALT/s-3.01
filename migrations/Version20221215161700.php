 ...
 */
final class Version20221215161700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_888A2A4CBCF5E72D ON vente (categorie_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_888A2A4CBCF5E72D ON vente');
    }
}
