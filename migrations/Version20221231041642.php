 ...
 */
final class Version20221231041642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piece ADD CONSTRAINT FK_44CA0B234F311658 FOREIGN KEY (dimensions_id) REFERENCES info_technique (id)');
