 ...
 */
final class Version20230107214222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_user CHANGE date_ajout date_ajout DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE document_vente CHANGE date_ajout date_ajout DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_user CHANGE date_ajout date_ajout DATETIME NOT NULL');
        $this->addSql('ALTER TABLE document_vente CHANGE date_ajout date_ajout DATETIME NOT NULL');
