 ...
 */
final class Version20230102182704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_vente (id INT AUTO_INCREMENT NOT NULL, vente_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_E12B5C3E7DC7170A (vente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE document_vente ADD CONSTRAINT FK_E12B5C3E7DC7170A FOREIGN KEY (vente_id) REFERENCES vente (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_vente DROP FOREIGN KEY FK_E12B5C3E7DC7170A');
