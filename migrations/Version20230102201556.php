 ...
 */
final class Version20230102201556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_vente CHANGE vente_id vente_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_vente CHANGE vente_id vente_id INT DEFAULT NULL');
    }
}
