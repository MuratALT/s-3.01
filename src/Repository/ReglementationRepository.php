...
/**
 * @extends ServiceEntityRepository<Reglementation>
 *
...
class ReglementationRepository extends ServiceEntityRepository
{
    ...
    public function save(Reglementation $entity, bool $flush = false): void
    {
    ...
    public function remove(Reglementation $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Reglementation[] Returns an array of Reglementation objects
//     */
...
//    public function findOneBySomeField($value): ?Reglementation
//    {
//        return $this->createQueryBuilder('r')
//            ->andWhere('r.exampleField = :val')
//            ->setParameter('val', $value)
